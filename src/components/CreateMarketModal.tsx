      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <CardContent>
              {isStaked ? (
                <div className="text-green-700">
                  ✅ You have staked {stakeAmount} tCORE. You can create markets.
                </div>
              ) : (
                <div className="space-y-2">
                  <div className="flex items-center text-red-700">
                    <AlertCircle className="h-4 w-4 mr-2" />
                    You need to stake tCORE before creating a market.
                  </div>
          ...
          <Button 
            ...
            disabled={!isStaked || !formData.projectTitle || !formData.amount || !formData.interestRate || !formData.tenor}
          >
            Create Loan Market
          </Button>
        </div>
