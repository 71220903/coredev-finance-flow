...
export const CORE_TESTNET_CONFIG = {
  ...
  // Updated with actual MarketFactory owner address (to be confirmed)
...
// DeveloperProfile ABI - Added missing ABI
...
// MarketFactory ABI - Fixed with correct function signatures
...
// StakingVault ABI - Fixed with correct function signatures
...
// Market ABI - Fixed with correct function signatures
...
// ReputationSBT ABI - Fixed mintAchievement return type
