        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-12 z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-10">
              {/* Innovation Badge */}
              <div className="inline-flex items-center bg-gradient-to-r from-blue-900/50 to-purple-900/50 border border-blue-500/30 px-6 py-3 rounded-full backdrop-blur-sm">
                <div className="w-3 h-3 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mr-3 animate-pulse"></div>
                <span className="text-base font-semibold bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-6">
                {!isConnected ? (
                  <div className="flex items-center space-x-4 bg-gradient-to-r from-gray-900/80 to-blue-900/80 border border-blue-500/30 rounded-2xl px-8 py-5 backdrop-blur-sm">
                    <Wallet className="h-6 w-6 text-blue-400 animate-pulse" />
                    <span className="text-gray-200 font-semibold text-lg">Connect Web3 Wallet to Enter the Future</span>
                  </div>
                ) : (
                  <>
                    <Button 
                      ...
                      className="group bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 hover:from-blue-500 hover:via-purple-500 hover:to-cyan-500 text-white px-10 py-6 text-xl font-bold shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 transform hover:scale-105 border border-blue-400/20"
                    >
                      <Play className="mr-3 h-6 w-6 group-hover:scale-110 transition-transform" />
                      {isAdmin ? 'Access Neural Control Panel' : 'Launch DeFi Dashboard'}
                      <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform" />
                    </Button>
                    <Button size="lg" variant="outline" asChild className="px-10 py-6 text-xl font-bold border-2 border-blue-500/50 text-blue-400 hover:bg-blue-500/10 hover:border-blue-400 transition-all duration-300">
                      <Link to="/marketplace">
              ...
              <div className="flex items-center space-x-8 pt-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-base font-semibold text-gray-300">Zero-Knowledge Proofs</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Network className="h-6 w-6 text-blue-400 animate-pulse" />
                  <span className="text-base font-semibold text-gray-300">Cross-Chain Compatible</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Zap className="h-6 w-6 text-yellow-400 animate-pulse" />
                  <span className="text-base font-semibold text-gray-300">Lightning Fast</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                ...
                <div className="relative h-[700px] bg-gradient-to-br from-gray-900/50 to-blue-900/50 rounded-3xl shadow-2xl shadow-blue-500/20 overflow-hidden border border-blue-500/30 backdrop-blur-xl">
                  ...
                  >
                    {blockchainShowcase.map((item, index) => (
                      <div key={item.id} className="min-w-full h-full relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                          <div className="space-y-4">
                            <div className="flex items-center space-x-4">
                              <Badge className="bg-gradient-to-r from-blue-500/80 to-purple-500/80 text-white border-none px-4 py-2">
                                {item.category}
                              </Badge>
                            ...
                            <h3 className="text-4xl font-black mb-4 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
                              {item.title}
                            </h3>
                        ...
                        <div className="absolute top-4 right-4 w-20 h-20 border border-blue-400/30 rounded-lg flex items-center justify-center backdrop-blur-sm">
                  ...
                  <button
                    onClick={prevSlide}
                    className="absolute left-4 top-1/2 -translate-y-1/2 bg-blue-500/20 backdrop-blur-sm hover:bg-blue-500/40 text-white p-4 rounded-full transition-all duration-300 hover:scale-110 border border-blue-400/30"
                  >
                    <ChevronLeft className="h-8 w-8" />
                  </button>
                  <button
                    onClick={nextSlide}
                    className="absolute right-4 top-1/2 -translate-y-1/2 bg-blue-500/20 backdrop-blur-sm hover:bg-blue-500/40 text-white p-4 rounded-full transition-all duration-300 hover:scale-110 border border-blue-400/30"
                  >
                  ...
                  <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-4">
                    {blockchainShowcase.map((_, index) => (
                      <button
                        ...
                        className={`w-4 h-4 rounded-full transition-all duration-300 border border-blue-400/50 ${
                          index === currentSlide ? 'bg-blue-400 w-12' : 'bg-blue-400/30'
                        }`}
                      />
                    ))}
                  </div>
                ...
                <div className="absolute -bottom-12 -left-12 bg-gradient-to-r from-green-500/90 to-emerald-500/90 text-white p-8 rounded-3xl shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 border border-green-400/30 backdrop-blur-sm">
                  <div className="flex items-center space-x-4">
                    <CheckCircle className="h-10 w-10" />
                    <div>
                      <div className="font-black text-xl">Audited</div>
                      <div className="text-sm opacity-90">Smart Contracts</div>
                    </div>
                  </div>
                </div>

                <div className="absolute -top-12 -right-12 bg-gradient-to-r from-purple-500/90 to-indigo-500/90 text-white p-8 rounded-3xl shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-500 border border-purple-400/30 backdrop-blur-sm">
                  <div className="flex items-center space-x-4">
